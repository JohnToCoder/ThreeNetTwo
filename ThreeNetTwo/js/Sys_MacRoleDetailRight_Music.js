...
function btnOkClick() {
    ...
    AjaxForSysSearch(iFrameContent, '../../Manage/MacRoleRight/MusicDetail.aspx?strMenuTypeID=' + txtMenuTypeId + "&strRoleID=" + txtRoleId + "&strID=" + txtRightId + "&strRoleName=" + txtRoleName + "&pageIndex=" + txtPageIndex + "&KeyValue=" + txtKeyValue);
}
