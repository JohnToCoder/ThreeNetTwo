<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MD_Photos.aspx.cs" Inherits="ThreeNetTwo.Photo.MD_Photos" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../js/MD_Photo.js" type="text/javascript"></script>
...
<body>
                                ...
                                <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[相簿欣賞]-[所有相冊]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="54%">
                                        <table border="0" align="right" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td width="60">
                                                <div class="imgBtnSel" runat="server" id="btnSel">
                                                       查詢  
                                                    </div></td>
                                                <td width="60">
                                                <div class="imgBtnIns" runat="server" id="btnIns">
                                                       新增  
                                                    </div></td>
                                                <td width="60">
                                                <div class="imgBtnUpd" runat="server" id="btnUpd">
                                                       修改  
                                                    </div></td>
                                                <td width="60">
                                                <div class="imgBtnDel" runat="server" id="btnDel">
                                                       刪除  
                                                    </div></td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="gvTableStyle">
                                <tr>
                                    <td>
                                        <asp:GridView ID="Gv_Photo" runat="server"  AutoGenerateColumns="False" 
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ID">
                                                 ...
                                                 <asp:BoundField HeaderText="創建人" DataField="Creator" HtmlEncode="False" 
                                                    HtmlEncodeFormatString="False">
                                                    <HeaderStyle  CssClass="GvHeader" HorizontalAlign="Left" Width="18%"/>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="18%"/>
                                                 </asp:BoundField>
    ...
    <asp:Label ID="lblFlag" runat="server" Text="" CssClass="hide"></asp:Label>
