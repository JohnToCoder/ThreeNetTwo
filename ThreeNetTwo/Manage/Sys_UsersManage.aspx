<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_UsersManage.aspx.cs" Inherits="ThreeNetTwo.Manage.Sys_UsersManage" %>
...
<body>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[系統設置]-[用戶管理]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" class="gvTableStyle">
                                <tr>
                                    <td>
                                        ...
                                        CellPadding="4" BorderWidth="0px" GridLines="Vertical" BorderStyle="None"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="用戶照片">
                                                <ItemTemplate>
                                                    <asp:Image ID="ImgUrl" runat="server" CssClass="imgStyle" Height="50" Width="60"
                                                        ToolTip="點擊瀏覽大圖" ImageUrl='<%# Eval("ImgPath")%>' />
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="GvHeader" Width="60px" />
                                                <ItemStyle CssClass="GvItem" Width="60px" />
                                                </asp:TemplateField>
                                                <asp:BoundField HeaderText="用戶帳號"  DataField="UserCode">
                                                <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="80px" />
                                                 <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="80px"/>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="用戶名稱" DataField="UserName">
                                                <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="80px"/>
                                                 <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="80px" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="ImgPath">
                                                    <HeaderStyle CssClass="hide" />
                                                    <ItemStyle CssClass="hide" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="電話" DataField="TEL">
                                                <HeaderStyle CssClass="GvHeader"  HorizontalAlign="Right" Width="50px"/>
                                                 <ItemStyle CssClass="GvItem" HorizontalAlign="Right" Width="50px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="郵箱" DataField="Email">
                                                <HeaderStyle CssClass="GvHeader"  HorizontalAlign="Left" />
                                                 <ItemStyle CssClass="GvItem"  HorizontalAlign="Left" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="手機號碼" DataField="Mobile">
                                                <HeaderStyle CssClass="GvHeader" HorizontalAlign="Right" Width="80px"/>
                                                 <ItemStyle CssClass="GvItem" HorizontalAlign="Right" Width="80px"/>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="角色" DataField="RoleDesc">
                                                <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="80px"/>
                                                 <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="80px"/>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="IP" DataField="IP">
                                                <HeaderStyle CssClass="GvHeader"  HorizontalAlign="Right"/>
                                                 <ItemStyle CssClass="GvItem"  HorizontalAlign="Right"/>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="創建者" DataField="Creator"  >
                                                <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="50px" />
                                                <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="50px"/>
                                                </asp:BoundField>
    ...
    <div id="WinIns" title="  新增" collapsible="false" minimizable="false" maximizable="false"  style="padding: 15px;background:#fafafa; width:99%;height:99%;display:none; overflow:hidden">
           <div region="center" border="false" style="background: #fff; border: 1px solid #ccc;width:98%;height:93%;">
                <iframe id="subFrameIns" name="subFrameIns" scrolling="no" frameborder="0"  src="" style="width:100%;height:100%;"></iframe>
           </div> 
           <div region="south" border="false" style="text-align: center; vertical-align:middle; height: 25px; line-height: 25px;">                
                <table cellpadding="0" border="0" cellspacing="0" width="100%">
                    <tr><td align="right" style="padding-top:5px;">
                             <div id="btnInsYes"  class="BtnYesStyle">確定</div>
                        </td>
                         <td align="left" style="padding-left:15px;padding-top:5px;">
                             <div id="btnCancel1"  class="BtnNoStyle">取消</div>
                    </td></tr>
                 </table> 
           </div>    
    </div>
    
    <div id="WinSel"  title="  查詢" collapsible="false" minimizable="false" maximizable="false"  style="padding:15px; background:#fafafa; width:99%;height:99%;display:none; overflow:hidden">
           <div region="center" border="false" style="background: #fff; border: 1px solid #ccc;width:98%;height:93%;">
    ...
    <div id="WinUpd"  title="  修改" collapsible="false" minimizable="false" maximizable="false"  style="padding: 15px;background:#fafafa; width:99%;height:99%;display:none; overflow:hidden">
           <div region="center" border="false" style="background: #fff; border: 1px solid #ccc;width:98%;height:93%;">
                <iframe id="subFrameUpd" name="subFrameUpd" scrolling="no" frameborder="0"  src="" style="width:100%;height:100%;"></iframe>
           </div> 
           <div region="south" border="false" style="text-align: center; vertical-align:middle; height: 25px; line-height: 25px;">                
                <table cellpadding="0" border="0" cellspacing="0" width="100%">
                    <tr><td align="right" style="padding-top:5px;">
                             <div id="btnUpdYes" class="BtnYesStyle">確定</div>
                        </td>
                         <td align="left" style="padding-left:15px;padding-top:5px;">
                             <div id="btnCancel3"  class="BtnNoStyle">取消</div>
                    </td></tr>
                 </table> 
           </div>    
    </div>
      <asp:TextBox ID="txtPageIndex" runat="server" CssClass="hide"></asp:TextBox>
        <asp:Label  ID="lblFlag" runat="server" Text="Label"  style="display:none"></asp:Label>
        <asp:Label ID="lblOperator" runat="server" Text="Users" style="display:none"></asp:Label>
