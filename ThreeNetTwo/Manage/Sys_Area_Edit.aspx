<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_Area_Edit.aspx.cs" Inherits="ThreeNetTwo.Manage.Sys_Area_Edit" %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" border="0">
             <tr id="trMAC" runat="server">
                ...
                <td align="right">
                    <span>地區</span></td>
                <td>
                    <asp:TextBox ID="txtArea" runat="server" Text="" CssClass="text"></asp:TextBox>
                </td>
            </tr>
