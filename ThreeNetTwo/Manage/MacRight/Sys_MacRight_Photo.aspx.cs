...
{
    public partial class Sys_MacRight_Photo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    {
                        strClass = ArrKeyValue[0];
                        strName = ArrKeyValue[1];
                        strStartDate = ArrKeyValue[2];
                        strEndDate = ArrKeyValue[3];

                    }


                    dataBind(strName,strClass,strStartDate,strEndDate);


                    string strMacId = Request["MacId"].ToString();
        ...
        private void dataBind(string strName, string strClass, string strSDate, string strEDate)
        {
            ...
            SqlParameter[] param ={
                                     ...
                                     new SqlParameter("@PhotoName",strName),
