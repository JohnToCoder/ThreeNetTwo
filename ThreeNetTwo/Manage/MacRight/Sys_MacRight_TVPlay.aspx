<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_MacRight_TVPlay.aspx.cs" Inherits="ThreeNetTwo.Manage.MacRight.Sys_MacRight_TVPlay" %>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="Sys_GvMac" runat="server"  AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                         <asp:BoundField HeaderText="電視劇名稱" DataField="SCJM" HtmlEncode="False" 
