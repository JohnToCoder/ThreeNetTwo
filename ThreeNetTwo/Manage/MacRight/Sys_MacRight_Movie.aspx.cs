...
{
    public partial class Sys_MacRight_Movie : System.Web.UI.Page
    {
        ...
        private void dataBind(string strMovie,string strSDate,string strEDate)
        {
            ...
            SqlParameter[] param ={
                                     ...
                                     new SqlParameter("@Movie",strMovie),
