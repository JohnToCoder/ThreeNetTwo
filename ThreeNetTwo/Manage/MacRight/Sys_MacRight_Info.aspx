<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_MacRight_Info.aspx.cs" Inherits="ThreeNetTwo.Manage.MacRight.Sys_MacRight_Info" %>
...
<head runat="server">
    ...
    <script src="../../js/Sya_Mac_right_Info.js" type="text/javascript"></script>
     ...
     <style type="text/css">
        ...
        .setTBorder
        {
        	border-bottom:0px solid #73a4f6;
        	border-right:0px solid #73a4f6;
        }
    ...
    <form id="form1" runat="server">
      ...
      <div style=" padding-top:10px;">
       ...
       <div id="WinMore" title="  更多信息"  collapsible="false" minimizable="false" maximizable="false" class="divStyle" style="height:75%">
               <div region="center" border="false" class="subdivStyle" style="height:100%">
                    <iframe id="subFrame" allowtransparency=true name="subFrame" scrolling="no" frameborder="0"  src="" style="width:100%;height:100%;"></iframe>
               </div>   
     </div>
     
            <asp:TextBox ID="txtRole" runat="server" CssClass="hide"></asp:TextBox>
