...
{
    public partial class Sys_MacRight_TVPlay : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                        ...
                        {
                            strName = ArrKeyValue[0];
                            strStartDate = ArrKeyValue[1];
                            strEndDate = ArrKeyValue[2];

                        }

                        dataBind(strName, strStartDate,strEndDate);
        ...
        private void dataBind(string strName, string strSDate, string strEDate)
        {
            ...
            SqlParameter[] param ={
                                     ...
                                     new SqlParameter("@TVplay",strName),
