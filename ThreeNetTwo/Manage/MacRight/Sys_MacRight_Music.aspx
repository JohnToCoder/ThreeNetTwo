<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_MacRight_Music.aspx.cs" Inherits="ThreeNetTwo.Manage.MacRight.Sys_MacRight_Music" %>
                        ...
                        <tr >
                            <td>
                                <asp:GridView ID="Sys_GvMac" runat="server"  AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                         <asp:BoundField HeaderText="專輯名稱" DataField="AlbumName" HtmlEncode="False" 
                                         ...
                                         <asp:BoundField HeaderText="音樂" DataField="MusicName" HtmlEncode="False" 
                                            HtmlEncodeFormatString="False">
                                            <HeaderStyle  CssClass="GvHeader" HorizontalAlign="Left" Width="180px"/>
                                            <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="180px"/>
                                         </asp:BoundField>
