<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_MacRight_Photo.aspx.cs" Inherits="ThreeNetTwo.Manage.MacRight.Sys_MacRight_Photo" %>
                        ...
                        <tr>
                            <td colspan='2'>
                                <asp:GridView ID="Sys_GvMac" runat="server"  AutoGenerateColumns="False" 
                                    ...
                                    <Columns>
                                         <asp:BoundField HeaderText="所屬相冊" DataField="PictureCatalog" HtmlEncode="False" 
                                         ...
                                         <asp:BoundField HeaderText="相冊名稱" DataField="ImaDesc" HtmlEncode="False" 
                                            HtmlEncodeFormatString="False">
                                            <HeaderStyle  CssClass="GvHeader" HorizontalAlign="Left" Width="200px"/>
                                            <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="200px"/>
                                         </asp:BoundField>
