<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_Roles.aspx.cs" Inherits="ThreeNetTwo.Manage.Sys_Roles" %>
...
<head runat="server">
    ...
    <script src="../js/Sys_Role.js" type="text/javascript"></script>
</head>
<body>
    <form id="form1" runat="server">
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[系統設置]-[角色管理]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        CellPadding="4" BorderWidth="0px" GridLines="Vertical" BorderStyle="None"
                                            Width="100%" AllowPaging="True"  PageSize="13" 
                                            onrowdatabound="Gv_Role_RowDataBound" >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="角色代碼"  DataField="RoleCode">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left"/>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left"/>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="角色描述"  DataField="RoleDesc">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left"/>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left"/>
                                                </asp:BoundField>
      ...
      <asp:TextBox ID="txtSuccess" runat="server" CssClass="hide"></asp:TextBox>
          ...
          <div id="WinQX"  title="  權限設置" collapsible="false" minimizable="false" maximizable="false" style="padding: 5px;background: #fafafa; width:99%;height:99%;display:none">
               <div region="center" border="false" style="padding: 10px;background: #fff; border: 1px solid #ccc;width:95%;height:95%;">
          ...
          <div id="Win" title="  查詢" collapsible="false" minimizable="false" maximizable="false" class="divStyle" style="height:80%">
               <div region="center" border="false" class="subdivStyle" style="height:75%">
