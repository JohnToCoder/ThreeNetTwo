<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TVPlayDetail.aspx.cs" Inherits="ThreeNetTwo.Manage.MacRoleRight.TVPlayDetail" %>
...
<head runat="server">
    ...
    <script src="../../js/Sys_MacRoleDetailRight_TV.js" type="text/javascript"></script>
...
<body scroll="no" style="background-color: #e5f6fb;">
    ...
    <div>
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="gvTableStyle">
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="GvTVDetail" runat="server" AutoGenerateColumns="False" Width="100%"
                        CellPadding="4" BorderWidth="0px" GridLines="Vertical" BorderStyle="None" AllowPaging="True"
                        PageSize="11" OnRowDataBound="GvTVDetail_RowDataBound" OnPageIndexChanging="GvTVDetail_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="名稱" DataField="TVPlayName" HtmlEncode="False" HtmlEncodeFormatString="False">
