<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MusicDetail.aspx.cs" Inherits="ThreeNetTwo.Manage.MacRoleRight.MusicDetail" %>
...
<head runat="server">
    ...
    <script src="../../js/Sys_MacRoleDetailRight_Music.js" type="text/javascript"></script>
    <style type="text/css">
        form
        {
...
<body scroll="no" style="background-color: #e5f6fb;">
    ...
    <div>
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="gvTableStyle">
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="GvMusicDetail" runat="server" AutoGenerateColumns="False" Width="100%"
                        CellPadding="4" BorderWidth="0px" GridLines="Vertical" BorderStyle="None" AllowPaging="True"
                        PageSize="11" OnRowDataBound="GvMusicDetail_RowDataBound" OnPageIndexChanging="GvMusicDetail_PageIndexChanging">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="名稱" DataField="AlbumName" HtmlEncode="False" HtmlEncodeFormatString="False">
                            ...
                            <asp:BoundField HeaderText="詳細名稱" DataField="Name" HtmlEncode="False" HtmlEncodeFormatString="False">
                                <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="40%" />
                                <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="40%" />
                            </asp:BoundField>
