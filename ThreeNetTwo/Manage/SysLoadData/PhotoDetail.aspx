<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhotoDetail.aspx.cs" Inherits="ThreeNetTwo.Manage.SysLoadData.PhotoDetail" %>
        ...
        <tr>
            <td>
                <asp:GridView ID="GvPhotoDetail" runat="server" AutoGenerateColumns="False" Width="100%"
                    ...
                    PageSize="12" onpageindexchanging="GvPhotoDetail_PageIndexChanging" 
                    onrowdatabound="GvPhotoDetail_RowDataBound">
