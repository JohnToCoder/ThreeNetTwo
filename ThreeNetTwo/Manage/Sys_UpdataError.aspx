<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_UpdataError.aspx.cs" Inherits="ThreeNetTwo.Manage.Sys_UpdataError" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[同步管理]-[客戶端更新錯誤Log]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                           ...
                                           >
                                            ...
                                            <Columns>
                                                <asp:BoundField HeaderText="MAC地址" DataField="MAC" HtmlEncode="False" 
                                                  ...
                                                  <asp:BoundField HeaderText="公司名稱" DataField="UserName" HtmlEncode="False" 
                                                    HtmlEncodeFormatString="False">
                                                    <HeaderStyle  CssClass="GvHeader" HorizontalAlign="Left" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" />
                                                 </asp:BoundField>
                                                 ...
                                                 <asp:BoundField HeaderText="錯誤信息" DataField="Error" HtmlEncode="False" 
                                                    HtmlEncodeFormatString="False">
                                                    <HeaderStyle  CssClass="GvHeader" HorizontalAlign="Left" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" />
                                                 </asp:BoundField>
                                                 ...
                                                 <asp:BoundField HeaderText="更新日期" DataField="CreatDate" HtmlEncode="False" 
                                                    HtmlEncodeFormatString="False">
                                                    <HeaderStyle  CssClass="GvHeader" HorizontalAlign="Left" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" />
                                                 </asp:BoundField>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" border="0" id="TabSearch">
                   <tr id="trMAC" runat="server">
                        ...
                        <td align="right">
                            錯誤信息</td>
                        <td>
                            <asp:TextBox ID="txtError" runat="server" Text="" CssClass="text"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
                            更新時間</td>
                        <td>
                            <asp:TextBox ID="txtCreatDate" runat="server" Text="" CssClass="text"></asp:TextBox>
                        </td>                        
