<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sys_LoadTableLog.aspx.cs"
    Inherits="ThreeNetTwo.Manage.SysLoadTableLog.Sys_LoadTableLog" %>
...
<head runat="server">
    ...
    <script src="../../js/Sys_LoadTableLog.js" type="text/javascript"></script>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="95%" class="NText">
                                                        <span class="BText">你当前的位置</span>：[同步管理]-[客戶端表結構更新Log]
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellpadding="0" cellspacing="1" class="gvTableStyle">
                                    <tr>
                                        <td>
                                            <asp:GridView ID="GvLoadTableLog" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                BorderWidth="0px" GridLines="Vertical" BorderStyle="None" Width="100%" AllowPaging="True"
                                                PageSize="15" onpageindexchanging="GvLoadTableLog_PageIndexChanging" 
                                                onrowdatabound="GvLoadTableLog_RowDataBound">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField HeaderText="客戶端主機名稱" DataField="UserName" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                        <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="13%" />
                                                        <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="13%" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField HeaderText="步驟" DataField="OrderID" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                        <HeaderStyle CssClass="GvHeader" HorizontalAlign="right" Width="7%" />
                                                        <ItemStyle CssClass="GvItem" HorizontalAlign="right" Width="7%" />
                                                    </asp:BoundField>
