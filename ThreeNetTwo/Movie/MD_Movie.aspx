<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MD_Movie.aspx.cs" Inherits="ThreeNetTwo.Movie.MD_Movie" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[電影劇場]-[電影]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="Gv_Movie" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            PageSize="13" OnPageIndexChanging="Gv_Movie_PageIndexChanging" 
                                            OnRowDataBound="Gv_Movie_RowDataBound" 
                                            >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="MediaID">
                                                    <HeaderStyle CssClass="hide" />
                                                    <ItemStyle CssClass="hide" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField HeaderText="電影名稱" DataField="MovieName" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="100px"/>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="100px"/>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="播放地址" DataField="MoviesURL" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="150px"/>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="150px"/>
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="電影類型" DataField="MTClassName" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" />
                                                </asp:BoundField>
<%--                                                <asp:BoundField HeaderText="地區" DataField="Area" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" />
                                                </asp:BoundField>--%>
                                                ...
                                                <asp:BoundField HeaderText="電影簡介" DataField="Summary" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                ...
                                                <asp:BoundField DataField="CreatDate" HeaderText="創建時間">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="60px"/>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="60px"/>
                                                </asp:BoundField>
                                            </Columns>
    ...
    <div id="WinIns" title="  新增" collapsible="false" minimizable="false" maximizable="false"
        ...
        overflow: hidden">
        <div region="center" border="false" style="vertical-align:middle; background: #fff; border: 1px solid #ccc;
            width: 98%; height: 93%;">
    ...
    <asp:Label ID="lblOperator" runat="server" Text="Movie" style="display:none"></asp:Label>
