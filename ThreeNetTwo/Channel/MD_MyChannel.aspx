<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MD_MyChannel.aspx.cs" Inherits="ThreeNetTwo.Channel.MD_MyChannel" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[節目列表]-[我的節目]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <asp:GridView ID="gdvCurrent" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <Columns>
                                                <asp:TemplateField>
                                                    ...
                                                    <HeaderStyle CssClass="hide" Width="10px" />
                                                    <ItemStyle CssClass="hide" Width="10px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="圖標">
                                                    ...
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="70px"/>
                                                </asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="ProgramName" HeaderText="節目名稱">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" VerticalAlign="Middle"></HeaderStyle>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left"></ItemStyle>
                                                </asp:BoundField> 
                                                ...
                                                <asp:BoundField DataField="UserCode" HeaderText="收藏人">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" VerticalAlign="Middle"></HeaderStyle>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="CreatDate" HeaderText="收藏日期">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" VerticalAlign="Middle"></HeaderStyle>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left"></ItemStyle>
                                                </asp:BoundField>
                                                <%--  <asp:TemplateField>
                                                    <HeaderTemplate>
                                                        更多信息</HeaderTemplate>
                                                    <ItemTemplate>
                                                        <a href="javascript:showMoreInfo('<%# DataBinder.Eval(Container.DataItem,"ID")%>')">
                                                            更多信息</a>
                                                    </ItemTemplate>
