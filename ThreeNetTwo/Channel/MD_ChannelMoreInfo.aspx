<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MD_ChannelMoreInfo.aspx.cs"
    Inherits="ThreeNetTwo.Channel.MD_ChannelMoreInfo" %>
...
<head runat="server">
    ...
    <script src="../js/MD_ChannelMoreInfo.js" type="text/javascript"></script>
</head>
<body>
<form id="form1" runat="server">
                                    ...
                                    <td style="white-space: nowrap">
                                        <asp:GridView ID="gdvCurrent" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="PlayingDate" HeaderText="播放日期">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" VerticalAlign="Middle"></HeaderStyle>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left"></ItemStyle>
                                                </asp:BoundField>
                                                <asp:BoundField DataField="PlayingTime" HeaderText="播放時間">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" VerticalAlign="Middle"></HeaderStyle>
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left"></ItemStyle>
                                                </asp:BoundField> 
    ...
    <asp:TextBox ID="txtKeyID" runat="server" CssClass="hide"></asp:TextBox>
