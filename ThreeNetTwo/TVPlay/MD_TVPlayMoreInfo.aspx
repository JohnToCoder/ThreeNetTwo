<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MD_TVPlayMoreInfo.aspx.cs"
    Inherits="ThreeNetTwo.TVPlay.MD_TVPlayMoreInfo" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[電視劇場]-[電視劇分集]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table border="0" align="right" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td width="60">
                                                 ...
                                                 <td width="60">
                                                    <div class="imgBtnReturn" id="btnReturn" runat="server">返回
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" class="gvTableStyle">
                                <tr>
                                    <td>
                                        <asp:GridView ID="Gv_TVPlaySub" runat="server" AutoGenerateColumns="False" Width="100%"
                                            CellPadding="4" BorderWidth="0px" GridLines="Vertical" BorderStyle="None" AllowPaging="True"
                                            PageSize="13" DataKeyNames="ID" OnPageIndexChanging="Gv_TVPlaySub_PageIndexChanging"
                                            OnRowDataBound="Gv_TVPlaySub_RowDataBound">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="分集" DataField="OrderID" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                ...
                                                <asp:BoundField HeaderText="播放地址" DataField="TVPlayURL" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="200px" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="200px" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="TVPlayID">
                                                    <HeaderStyle CssClass="hide" Width="0" />
                                                    <ItemStyle CssClass="hide" Width="0" />
                                                </asp:BoundField>
