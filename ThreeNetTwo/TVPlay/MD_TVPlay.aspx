<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MD_TVPlay.aspx.cs" Inherits="ThreeNetTwo.TVPlay.MD_TVPlay" %>
...
<body style="word-break: break-all; word-wrap: break-word">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[電視劇場]-[電視劇]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" class="gvTableStyle">
                                <tr>
                                    <td>
                                        <asp:GridView ID="Gv_TVPlay" runat="server" AutoGenerateColumns="False" Width="100%"
                                            CellPadding="4" BorderWidth="0px" GridLines="Vertical" BorderStyle="None" AllowPaging="True"
                                            PageSize="13" OnPageIndexChanging="Gv_Replace_PageIndexChanging" OnRowDataBound="Gv_TVPlay_RowDataBound"
                                            DataKeyNames="ID">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="MTClassID">
                                                    <HeaderStyle CssClass="hide" Width="0" />
                                                    <ItemStyle CssClass="hide" Width="0" />
                                                </asp:BoundField>
                                                <asp:BoundField DataField="MediaSourceID">
                                                    <HeaderStyle CssClass="hide" Width="0" />
                                                    <ItemStyle CssClass="hide" Width="0" />
                                                </asp:BoundField>
                                                <asp:TemplateField HeaderText="劇照">
                                                    <ItemTemplate>
                                                        <asp:Image ID="ImgUrl" runat="server" CssClass="imgStyle" Height="50" Width="100"
                                                            ToolTip="點擊瀏覽大圖" ImageUrl='<%# Eval("ImgPath")%>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle CssClass="GvHeader" Width="100px" />
                                                    <ItemStyle CssClass="GvItem" Width="100px" />
                                                </asp:TemplateField>
                                                <asp:BoundField HeaderText="電視名稱" DataField="TVPlayName" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="100px" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="100px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="播放地址" DataField="TVPlayURL" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="250px" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="250px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="分類" DataField="ClassDesc" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="50px" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="50px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="上映時間" DataField="ComeOut" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="90px" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="90px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="劇情簡介" DataField="Summary" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="300px" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="300px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="媒體來源" DataField="MediaSource" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                ...
                                                <asp:BoundField DataField="CreatDate" HeaderText="創建時間">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="100px" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="100px" />
                                                </asp:BoundField>
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                        <a href="javascript:TVPlayEdit('<%# DataBinder.Eval(Container.DataItem,"ID")%>')">Detail</a>
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Left" CssClass="GvHeader" Width="80px" />
                                                    <ItemStyle HorizontalAlign="Left" CssClass="GvItem" Width="80px" />
                                                </asp:TemplateField>
                                            </Columns>
    ...
    <div id="WinIns" title="  新增" collapsible="false" minimizable="false" maximizable="false"
        ...
        <div region="center" border="false" class="subdivStyle">
    ...
    <div id="WinMore" title="  更多信息" collapsible="false" minimizable="false" maximizable="false"
        ...
        <div region="center" border="false" class="subdivStyle" style="background: #fff;
            ...
            <iframe id="IframeMore" name="IframeMore" scrolling="no" frameborder="0" src="" style="width: 100%;
                height: 100%;"></iframe>
        </div>
        <div region="south" border="false" style="text-align: center; vertical-align: middle;
            height: 25px; line-height: 25px;">
            <table cellpadding="0" border="0" cellspacing="0" width="100%">
                <tr>
                    <td align="right" style="padding-top: 5px;">
                        <div id="Div1" class="BtnYesStyle">
                            確定</div>
                    </td>
                    <td align="left" style="padding-left: 15px; padding-top: 5px;">
                        <div id="Div2" class="BtnNoStyle">
                            取消</div>
                    </td>
                </tr>
            </table>
    ...
    <asp:Label ID="lblOperator" runat="server" Text="TVPlay" Style="display: none"></asp:Label>
