<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MD_Album.aspx.cs" Inherits="ThreeNetTwo.Music.MD_Album" %>
...
<body style =" word-break :break-all ; word-wrap:break-word ">
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[音樂點播]-[音樂維護]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="gvTableStyle">
                                <tr>
                                    <td>
                                        <asp:GridView ID="Gv_Album" runat="server" AutoGenerateColumns="False" Width="100%"
                                            CellPadding="4" BorderWidth="0px" GridLines="Vertical" BorderStyle="None" AllowPaging="True"
                                            PageSize="13" OnPageIndexChanging="Gv_Album_PageIndexChanging" OnRowDataBound="Gv_Album_RowDataBound">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="專輯類型" DataField="ClassDesc" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                ...
                                                <asp:BoundField HeaderText="專輯地址" DataField="AlbumURL" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                ...
                                                <asp:BoundField HeaderText="創建時間" DataField="CreatDate" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                 ...
                                                 <asp:TemplateField HeaderText="Detail">
                                                    <ItemTemplate>
                                                        <a href="javascript:MusicEdit(<%# Eval("ID")%>)">Detail</a>
                                                    </ItemTemplate>
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left"  Width="7%" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left"  Width="7%" />
                                                </asp:TemplateField>
    ...
    <asp:Label ID="lblOperator" runat="server" Text="Music" Style="display: none"></asp:Label>
