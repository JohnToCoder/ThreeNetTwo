<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MD_Music.aspx.cs" Inherits="ThreeNetTwo.Music.MD_Music" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="NText">
                                                    <span class="BText">你当前的位置</span>：[音樂點播]-[所有音樂]
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" class="gvTableStyle">
                                <tr>
                                    <td>
                                        <asp:GridView ID="Gv_Music" runat="server" AutoGenerateColumns="False" Width="100%"
                                            CellPadding="4" BorderWidth="0px" GridLines="Vertical" BorderStyle="None" AllowPaging="True"
                                            PageSize="13" OnRowDataBound="Gv_Music_RowDataBound" OnPageIndexChanging="Gv_Music_PageIndexChanging">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="專輯名" DataField="AlbumName" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="12%" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="12%" />
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField HeaderText="歌曲類型" DataField="ClassDesc" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="8%" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="8%" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="演唱者" DataField="Creator" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="8%" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="8%" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="歌曲地址" DataField="MusicURL" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="15%" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="15%" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="發行時間" DataField="ComeOut" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="9%" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="9%" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="創建者" DataField="Creator1" HtmlEncode="False" HtmlEncodeFormatString="False">
                                                    <HeaderStyle CssClass="GvHeader" HorizontalAlign="Left" Width="7%" />
                                                    <ItemStyle CssClass="GvItem" HorizontalAlign="Left" Width="7%" />
                                                </asp:BoundField>
